...
// Buscar traz todos os usuários que atendem por nome ou nick
...
// BuscaPorID traz usuário do banco de dados
...
// BuscarPorEmail busca usuário por email e retorna o id e senha com hash
...
// PararDeSeguir faz com que um usuário deixe de seguir outro
...
func (repositorio Usuarios) BuscarSeguidores(usuarioID, seguidorID uint64) ([]modelos.Usuario, error) {
	linhas, erro := repositorio.db.Query(`
...
func (repositorio Usuarios) BuscarSeguindo(usuarioID, seguidorID uint64) ([]modelos.Usuario, error) {
	linhas, erro := repositorio.db.Query(`
		select u.id, u.nome, u.nick, u.email, u.criadoEm
