...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel deletar outro usuário."))
		return
	}
...
// SeguirUsuarios faz com os usuários se sigam
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel seguir a você mesmo."))
		return
	}
...
// PararDeSeguir faz com que um usuário pare de seguir outro
...
// BuscarSeguidores tráz todos os seguidores de um usuário
func BuscarSeguidores(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	seguidores, erro := repositorio.BuscarSeguidores(usuarioID, 500)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
// BuscarSeguindo traz todos os usuários que um usuário específico está seguindo
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	senhaSalvaNoBanco, erro := repositorio.BuscarSenha(usuarioID, 500)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
